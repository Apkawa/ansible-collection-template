...
class ActionModule(ActionBase):
    ...
    def get_distribution(self, task_vars):
        ...
        try:
            ...
            display.debug("{action}: distribution: {dist}".format(action=self._task.action,
                                                                  dist=distribution))
            return distribution
    ...
    def _check_argspec(self):
        ...
        if not valid:
            raise AnsibleActionFail(argspec_result)
        return valid
    ...
    def perform_cmd(self, task_vars, distribution):
        ...
        try:
            ...
            if self._play_context.check_mode:
                ...
                cmd_result = self._low_level_execute_command(echo_exc,
